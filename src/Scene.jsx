...
function Scene() {
  return (
    <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 4], fov: 45 }} gl={{ antialias: false, powerPreference: 'high-performance' }} shadows={false}>
      ...
      <Suspense fallback={null}>
        {/* <CameraRig> */}
          ...
          <group >
            ...
            <Model5 scale={0.02} position={[0, -50.45, 2.136]} rotation={[1.5, 0, 0]} />
          </group>
          ...
          <Stars saturation={0} count={400} speed={2} />
